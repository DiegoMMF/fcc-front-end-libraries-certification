...
// components, and each component had its own local state, the entire state
// of your app would be defined by a single state object housed in the Redux
// store. This is the first important principle to understand when learning
// Redux: the Redux store is the single source of truth when it comes to
// application state.

// This also means that any time any piece of your app wants to update state,
// it must do so through the Redux store. The unidirectional data flow makes
...
// to create the Redux store. This method takes a reducer function as a
// required argument. The reducer function is covered in a later challenge, and
// is already defined for you in the code editor. It simply takes state as an
